...
(() => { // webpackBootstrap
    ...
    var __webpack_modules__ = ({
        ...
        /***/
            ...
            function Popup() {
                const {
                    activeConfig, status, isEnabled, configs, error
                } = (0, useGamepadConfigs_1.default)();
                const {
                    gameName
                } = (0, useGameStatus_1.default)();
                return (react_1.default.createElement("div", {
                        className: "popup vertical"
                    },
                    ...
                    react_1.default.createElement(MainConfigEditor_1.default, {
                        activeConfig: activeConfig,
                        isEnabled: isEnabled,
                        status: status,
                        configs: configs,
        ...
        /***/
            ...
            function GamepadConfigEditor({
                name, onSubmitChanges, onCancelCreate, onActivate, onDelete
            }) {
                const {
                    status, config: storedGamepadConfig
                } = (0, reduxHooks_1.useAppSelector)((state) => (0, selectors_1.getGamepadConfig)(state, name));
                ...
                const handleToggleEditing = (0, react_2.useCallback)(() => {
                    if (isNewDraft && isEditing) {
                        if ((0, confirmUtil_1.confirm)('Yeni profil oluşturmayı iptal etmek istediğinden emin misin?')) {
                            onCancelCreate();
                        }
                        return;
                    }
                    if (isEditing && (!hasChanges || (0, confirmUtil_1.confirm)('İptal etmek istediğinden emin misin? Tüm değişiklikler kaybedilecek.'))) {
                        // Reset
                        dispatchState({
                            type: 'reset',
                ...
                const handleDelete = (0, react_2.useCallback)(() => {
                    if ((0, confirmUtil_1.confirm)('Bu profili silmek istediğinden emin misin?')) {
                        onDelete(name);
                    }
                }, [name, onDelete]);
                ...
                return (react_2.default.createElement("form", {
                    ...
                    react_2.default.createElement("section", {
                    ...
                    react_2.default.createElement("section", {
                            className: "horizontal space-between padding-top-s"
                        },
                        react_2.default.createElement("div", {
                                className: "margin-right-s"
                            },
                            react_2.default.createElement(react_1.DefaultButton, {
                                onClick: handleToggleEditing
                            }, isEditing ? 'İptal' : 'Düzenle'), !isEditing ? (react_2.default.createElement(react_1.DefaultButton, {
                                className: "margin-left-s",
                                disabled: isDefaultConfig,
                                onClick: handleDelete,
                                title: isDefaultConfig ? 'Varsayılan profil silinemez' : undefined
                            }, "Sil")) : null, !isEditing ? (react_2.default.createElement(react_1.DefaultButton, {
                                className: "margin-left-s",
                                onClick: handleExport
                            }, "Dışa Aktar")) : null),
                        isEditing ? (react_2.default.createElement(react_1.PrimaryButton, {
                            type: "submit",
                            disabled: state.errors.hasErrors || !hasChanges || isSubmitting,
                            iconProps: saveIcon
                        }, isNewDraft ? 'Oluştur' : 'Kaydet')) : (react_2.default.createElement(react_1.PrimaryButton, {
        ...
        /***/
            ...
            function ConfigTitle({
                ...
                return (react_1.default.createElement("div", {
                    ...
                    react_1.default.createElement("span", {
                        className: (0, classnames_1.default)('overflow-ellipsis margin-right-s', status && 'selector-active')
                    }, name),
            ...
            function renderOption(option) {
                var _a;
                return option ? react_1.default.createElement(ConfigTitle, {
                    name: option.text,
                    status: ((_a = option.data) === null || _a === void 0 ? void 0 : _a.active) && 'Aktif'
                }) : null;
            }
            ...
            function GamepadConfigSelector({
                className, currentConfig, activeConfig, isEnabled, isPaid, allConfigs, setCurrentConfig, addNewConfig, importConfig, openPaymentPage, toggleShowSettings,
            }) {
                ...
                const dropdownOptions = (0, react_1.useMemo)(() => configsArray.map((configName) => ({
                    key: configName,
                    text: configName,
                    data: isEnabled && configName === activeConfig ? {
                        active: true
                    } : undefined,
                })), [configsArray, isEnabled, activeConfig]);
                return isNew ? (react_1.default.createElement("div", {
                    ...
                    react_1.default.createElement(react_2.DefaultButton, {
                    ...
                    react_1.default.createElement("div", {
                        ...
                        react_1.default.createElement(NewConfigButton_1.default, {
                            isPaid: isPaid,
                            disabled: configsArray.length >= gamepadConfig_1.MAX_NUM_CONFIGS - 1,
        ...
        /***/
            ...
            function GlobalPrefsEditor({
                ...
                const handleChange = (0, react_2.useCallback)((e, checked) => {
                    dispatch((0, actions_1.updatePrefsAction)(Object.assign(Object.assign({}, prefs), {
                        showControlsOverlay: !!checked
                    })));
                }, [dispatch, prefs]);
        ...
        /***/
            ...
            function Header({
                gameName, activeConfig, isEnabled
            }) {
                ...
                const handleToggle = (0, react_1.useCallback)((event, checked) => {
                    if (!checked) {
                        ...
                        dispatch((0, actions_1.activateGamepadConfigAction)({
                            name: activeConfig
                        }));
                    }
                }, [dispatch, activeConfig]);
                return (react_1.default.createElement(react_2.ThemeProvider, {
                        theme: theme_1.fluentXboxHeaderTheme
                    },
                    react_1.default.createElement("header", {
                        ...
                        react_1.default.createElement("div", {
                            ...
                            react_1.default.createElement(react_2.Toggle, {
                                title: `kalvye ve fareyi ${isEnabled ? 'Kapat' : 'Aç'}`,
                                checked: isEnabled,
                        ...
                        react_1.default.createElement("div", {
                            ...
                            react_1.default.createElement("div", {
                                ...
                                react_1.default.createElement("div", {
                                    ...
                                    react_1.default.createElement("small", null, "Oyun:"),
                                    " ",
                                    react_1.default.createElement("span", null, gameName || 'Bulunamadı')),
                                react_1.default.createElement("div", {
                                        className: "overflow-ellipsis"
                                    },
                                    react_1.default.createElement("small", null, "Kontrol Profili:"),
                                    " ",
                                    react_1.default.createElement("span", null, activeConfig || 'Bulunamadı'))),
        ...
        /***/
            ...
            const getMenuItems = (isPaid, onPay) => [{
                key: 'version',
                text: `Sürüm ${chrome.runtime.getManifest().version}`,
                disabled: true,
            }, {
                key: 'upgrade',
                text: 'Watifu is here',
                ...
                key: 'xcloud',
                text: 'xCloud\'a götür beni',
                href: 'https://xbox.com/en-US/play',
                target: '_blank',
                iconProps: {
                    iconName: 'Cloud'
                },
            ...
            function HeaderMoreOptions() {
                ...
                return (react_2.default.createElement(react_1.IconButton, {
                    menuProps: {
                        items: menuItems,
            ...
            function Logo({
                ...
                return (react_1.default.createElement("div", {
                    ...
                    react_1.default.createElement("img", {
                        ...
                        style: Object.assign(Object.assign({}, imgStyle), opacity),
                        className: "margin-right-s"
                    }),
                    react_1.default.createElement("img", {
        ...
        /***/
            ...
            function MainConfigEditor({
                activeConfig, isEnabled, configs, status, error
            }) {
                const dispatch = (0, reduxHooks_1.useAppDispatch)();
                ...
                const {
                    paid
                } = (0, reduxHooks_1.useAppSelector)(selectors_1.getPayment);
                (0, react_1.useEffect)(() => {
                ...
                const handleSubmitGamepadConfig = (0, react_1.useCallback)((name, gamepadConfig) => {
                    dispatch((0, actions_1.modifyGamepadConfigAction)({
                        name, gamepadConfig
                    }));
                    setCurrentConfig(name);
                }, [dispatch]);
                const handleDeleteGamepadConfig = (0, react_1.useCallback)((name) => {
                    dispatch((0, actions_1.deleteGamepadConfigAction)({
                        name
                    }));
                ...
                return (react_1.default.createElement("div", {
                    className: "box margin-full vertical full-height"
                }, status === 'failure' ? (react_1.default.createElement(ErrorDetails_1.default, {
                    error: error
                })) : status !== 'success' ? (react_1.default.createElement(react_2.Spinner, {
                ...
                }, showSettings ? (react_1.default.createElement(GlobalPrefsEditor_1.default, {
                    goBack: toggleShowSettings
                })) : (react_1.default.createElement(react_1.default.Fragment, null,
                    react_1.default.createElement(GamepadConfigSelector_1.default, {
                    ...
                    react_1.default.createElement(GamepadConfigEditor_1.default, {
                        name: currentConfig,
        ...
        /***/
            ...
            function NewConfigButton({
                disabled, isPaid, allConfigs, onCreate, onImport, onOpenPaymentPage,
            }) {
                isPaid = true;
                ...
                const handleImport = (0, react_1.useCallback)(() => {
                    ...
                    .then((config) => {
                            ...
                            if (isMounted())
                                setName('');
                            alert('Profil başarıyla içe aktarıldı');
                        })
                        .catch((errorMsg) => {
                            console.error('İçe aktarım hatayla karşılaştı', errorMsg);
                            alert(errorMsg);
                        });
                ...
                return (react_1.default.createElement(react_1.default.Fragment, null,
                    react_1.default.createElement(react_2.IconButton, {
                            ...
                            ariaLabel: "Yeni Profil Oluştur",
                            disabled: disabled
                        },
                        react_1.default.createElement(icons_1.PlusCircleIcon, null)),
                    isOpen ? (react_1.default.createElement(react_2.Callout, {
                        ...
                        react_1.default.createElement("div", {
                            ...
                            isTaken ? react_1.default.createElement("div", {
                                className: "error margin-top-s"
                            }, "Bu Profil Adı Zaten Kayıtlı!") : null,
                            react_1.default.createElement("div", {
                                    className: "horizontal space-between margin-top-s"
                                },
                                react_1.default.createElement(react_2.DefaultButton, {
                                    disabled: !name || isTaken,
                                    onClick: handleImport
                                }, "İçe Aktar"),
                                react_1.default.createElement(react_2.PrimaryButton, {
                                    disabled: !name || isTaken,
        ...
        /***/
            ...
            function SensitivitySelector({
                dispatch, disabled, readOnly, sensitivity
            }) {
                ...
                return (react_1.default.createElement("div", null,
                    react_1.default.createElement(react_2.SpinButton, {
                        label: "Fare Hassaslığı (1-99)",
                        className: (0, classnames_1.default)(readOnly && 'no-pointer-events'),
                    ...
                    react_1.default.createElement("small", null, "Ayarları oyun içerisinden de ayarlamanız gerekebilir, oyundan oyuna değişiklik gösterir.")));
            }
        ...
        /***/
            ...
            function ShortcutCommandsList() {
                ...
                return (react_2.default.createElement("section", null,
                    react_2.default.createElement("h3", null, "Kısayollar"), !commands ? (react_2.default.createElement(react_1.Shimmer, null)) : (react_2.default.createElement("div", null,
                        commands.map((command) => {
                            ...
                            return (react_2.default.createElement("div", {
                                ...
                                react_2.default.createElement(react_1.Label, {
                                    htmlFor: htmlId
                                }, command.description),
        ...
        /***/
            ...
            function StickSelector({
                disabled, stick, onChange, readOnly
            }) {
                ...
                return (react_1.default.createElement(react_2.ChoiceGroup, {
                    className: (0, classnames_1.default)(readOnly && 'no-pointer-events'),
                    disabled: disabled,
                    label: "Fare haraketleri hangisini kontrol etmeli?",
        ...
        /***/
            ...
            function UpsellModal() {
                ...
                return (react_2.default.createElement(react_responsive_modal_1.Modal, {
                        center: true,
                        open: show,
                        onClose: handleClose,
                        showCloseIcon: true,
                    ...
                    react_2.default.createElement("div", {
                        ...
                        react_2.default.createElement("h2", null, "Daha fazla özellik için yükselt kardeşim"),
                        react_2.default.createElement("p", null,
                            react_2.default.createElement("strong", null, "Tek seferlik ödemeyle ömür boyu erişim!")),
                        ...
                        react_2.default.createElement("div", {
                            ...
                            react_2.default.createElement(react_1.CompoundButton, {
                                primary: true,
        ...
        /***/
            ...
            function useGameStatus() {
                const {
                    gameName, status
                } = (0, reduxHooks_1.useAppSelector)(selectors_1.getGameName);
        ...
        /***/
            ...
            function useGamepadConfigs() {
                ...
                } = (0, reduxHooks_1.useAppSelector)(selectors_1.getAllGamepadConfigs);
                ...
                return {
                    activeConfig, configs, isEnabled, status, error
                };
            }
        ...
        /***/
            ...
            function keyConfigReducer(initialState, state, action) {
                ...
                if (action.type === 'updateKeyConfig') {
                    const updated = Object.assign(Object.assign({}, state), {
                        config: Object.assign(Object.assign({}, state.config), {
                            keyConfig: Object.assign(Object.assign({}, state.config.keyConfig), {
                                [action.button]: Array.isArray(action.keyMap) && !action.keyMap.length ? undefined : action.keyMap
                            })
                        })
                    });
                    const {
                        invalidButtons, hasErrors
                    } = (0, gamepadConfig_1.processGamepadConfig)(updated.config.keyConfig);
                    const hasKeyConfigChanges = !(0, deep_equal_1.default)(initialState.config.keyConfig, updated.config.keyConfig);
                    updated.changes = Object.assign(Object.assign({}, updated.changes), {
                        keyConfig: hasKeyConfigChanges
                    });
                    // Still allow update if there are errors, but we will block submit
                    updated.errors = Object.assign(Object.assign({}, updated.errors), {
                ...
                if (action.type === 'updateSensitivity' || action.type === 'updateMouseControls') {
                    const {
                        type
                    } = action, other = __rest(action, ["type"]);
                    const mouseConfig = Object.assign(Object.assign({}, state.config.mouseConfig), other);
                    const {
                        errors, hasErrors
                    } = (0, gamepadConfig_1.validateMouseConfig)(mouseConfig);
                    const hasMouseConfigChanges = !(0, deep_equal_1.default)(initialState.config.mouseConfig, mouseConfig);
                    const updated = Object.assign(Object.assign({}, state), {
                        changes: Object.assign(Object.assign({}, state.changes), {
                            mouseConfig: hasMouseConfigChanges
                        }),
                        config: Object.assign(Object.assign({}, state.config), {
                            mouseConfig
                        }),
                        errors: Object.assign(Object.assign({}, state.errors), {
                            mouseConfig: Object.assign({}, errors),
        ...
        /***/
            ...
            exports.activateGamepadConfigAction = (0, toolkit_1.createAsyncThunk)('config/activate', ({
                name
            }, {
                getState
            }) => _setActiveConfig(name, getState()));
            ...
            exports.deleteGamepadConfigAction = (0, toolkit_1.createAsyncThunk)('config/delete', ({
                name
            }, {
                getState
            ...
            exports.modifyGamepadConfigAction = (0, toolkit_1.createAsyncThunk)('config/modify', ({
                name, gamepadConfig
            }, {
                getState
            }) => __awaiter(void 0, void 0, void 0, function*() {
        ...
        /***/
            ...
            function getLocalGameStatus() {
                return __awaiter(this, void 0, void 0, function*() {
                    const data =
                        yield chrome.storage.local.get(LocalStorageKeys.GAME_NAME);
            ...
            function storeSeenOnboarding() {
                return chrome.storage.sync.set({
                    [SyncStorageKeys.ONBOARDED]: true
                });
            }
            ...
            function storeGamepadConfig(name, gamepadConfig) {
                return chrome.storage.sync.set({
                    [`${SyncStorageKeys.GAMEPAD_CONFIGS}:${name}`]: gamepadConfig
                });
            }
            ...
            function deleteGamepadConfig(name) {
                if (name === gamepadConfig_1.DEFAULT_CONFIG_NAME) {
                    throw new Error('Varsayılan Profili Silemezsin');
                }
            ...
            function storeActiveGamepadConfig(name) {
                ...
                return chrome.storage.sync.set({
                    [SyncStorageKeys.ENABLED]: true, [SyncStorageKeys.ACTIVE_GAMEPAD_CONFIG]: name,
                });
            }
            ...
            function normalizeGamepadConfigs(data = {}) {
                ...
                const isEnabled = data[SyncStorageKeys.ENABLED] === undefined ? !!data[SyncStorageKeys.ACTIVE_GAMEPAD_CONFIG] : data[SyncStorageKeys.ENABLED];
            ...
            function getAllStoredSync() {
                return __awaiter(this, void 0, void 0, function*() {
                    const data =
                        yield chrome.storage.sync.get(null);
        ...
        /***/
            ...
            function exportConfig(config, name) {
                ...
                link.download = `watifu_xcloud_profil_${name || 'game'}.json`;
                ...
                return new Promise((resolve, reject) => {
                    input.onchange = function fileSelected() {
                        ...
                        reader.onload = function receivedText(e) {
                            ...
                            if (!isValid || !config) {
                                return reject('Profil dosyası hasarlı veya yok');
                            }
        ...
        /***/
            ...
            function sendMessage(msg) {
                return __awaiter(this, void 0, void 0, function*() {
                    const tabs =
                        yield (0, tabsUtils_1.getAllTabs)();
                    tabs.forEach((tab) => {
        ...
        /***/
            ...
            react_dom_1.default.render(react_1.default.createElement(react_1.StrictMode, null,
                react_1.default.createElement(react_redux_1.Provider, {
                    ...
                    react_1.default.createElement(react_2.ThemeProvider, {
                            theme: theme_1.fluentXboxTheme
                        },
