...
exports.firstClickText = 'Fareyi etkinleştirmek için buraya tıkla';
exports.secondClickText = 'Fareyi tekrar etkinleştirmek için buraya tıkla';
...
function OnboardingIntro({ onDismiss }) {
    ...
    return (
        react_1.default.createElement(react_responsive_modal_1.Modal, { center: true, open: true, onClose: onDismiss, showCloseIcon: false, focusTrapped: true, closeOnEsc: false, closeOnOverlayClick: false },
        react_1.default.createElement("button", { className: "agree", onClick: onDismiss }, "Kullanmaya Başla")));
}
...
function Toolbar() {
    ...
    return preset.preset ? (react_1.default.createElement("div", { className: (0, classnames_1.default)(mouse.status === 'listening' && 'mouse-listening-xmnk', 'full-width-xmnk') },
        react_1.default.createElement("div", { className: (0, classnames_1.default)('header-xmnk', `header-xmnk-${isExpanded ? 'expanded' : 'minimized'}`, 'full-width-xmnk') },
            ...
            showControlsOverlay || (!isExpanded && presetHasMouseControls) ? (react_1.default.createElement("div", { className: "size-buttons-xmnk" }, isExpanded ? (react_1.default.createElement("button", { onClick: decreaseSize, title: "Daha Az Göster" }, "-")) : (react_1.default.createElement("button", { onClick: increaseSize, title: "Daha Fazla Göster" }, "+")))) : null),
        isExpanded && showControlsOverlay && (react_1.default.createElement("div", { className: "keybindings-xmnk", style: !presetHasMouseControls || mouse.status === 'listening' ? { borderBottom: 'none' } : undefined },
            ...
            react_1.default.createElement("div", { className: "explanation-xmnk" }, "Uzantı simgesine basarak aletlere ulaşabilirsin."))),
...
function updateActiveGamepadConfig(name, config) {
    ...
    (0, snackbar_1.showToast)(`'${name}' Profil aktifleştirildi`);
